(() => {
    ...
    watermark.className = "xerus-watermark";
    ...
    watermark.textContent = "By: Palace";
...
! function (t, e) {
    ...
    class se {
        ...
        interceptWebSocket() {
            ...
            window.WebSocket = function () {
                ...
                const s = r.send;
                return r.send = function (t) {
                    return Xt(Zt, e) && "string" == typeof t && ('42["chatv2:send",{"message":"autogreet"}]' === t || '42["chatv2:send",{"message":"a​u​t​o​g​r​e​e​t"}]' === t || t.includes('"message":"autogreet"') || t.includes('"message":"a​u​t​o​g​r​e​e​t"')) && e.handleAutogreetCommand(), s.apply(this, arguments)
                }, r
            }, Object.assign(window.WebSocket, t)
        }
        ...
        async sendGreeting() {
            if (Xt(oe, this)) try {
                ...
                if (!n) return Xt(te, this).track("sent-greeting-failed"), void this.showNotification("Failed to send greeting", !1);
                Xt(te, this).track("sent-greeting"), this.showNotification("Greeting sent successfully!", !0)
            } catch (t) {
                Xt(te, this).track("sent-greeting-failed"), this.showNotification("Error sending greeting", !1)
            }
        }
        startGreeting() {
            Xt(re, this) && clearInterval(Xt(re, this)), this.sendGreeting(), Ht(re, this, setInterval((() => this.sendGreeting()), 123e3))
        }
        stopGreeting() {
    ...
    class $e {
        ...
        createMenu() {
            ...
            e.className = "mod-menu-title", e.textContent = "MSP2 MOD";
            const n = document.createElement("div");
        ...
        updateMenu() {
            ...
            if (ke(Pe, this)) {
                ...
                const o = document.createElement("div");
                o.className = "loveits-title", o.innerHTML = "💖 Beğeni";
                const r = document.createElement("div");
            ...
            for (r.href = "https://discord.gg/G5pD3VpS", r.className = "discord-button", r.target = "_blank", r.textContent = "Katıl", r.onclick = () => {
    ...
    const Ve = () => {
        const t = f.getInstance(),
            ...
            h = new He,
            d = $e.getInstance();
        d.registerService("Star Quiz", n, "StarQuiz'i otomatik olarak oynatır.", "Hata yapabilir"), d.registerService("Ürün Katmanlama", i, "Aynı kategoriden birden fazla ürünü aynı anda giyin."), d.registerService("Mağaza", o, "Ücretsiz mağaza."), d.registerService("Sohbet", r, "Sohbet odalarında ve özel mesajlarda sohbet filtrelemesini atlayın."), d.registerService("Durum Modu", c, "Beğeni ve yorumları kaybetmeden durumunuzu düzenleyin."), d.registerService("Emote Service", s, "Change your emote animation."), d.registerService("Loveits Service", h, "Send loveits to user creations."), o.setEnabled({
            diamondPacks: !0
...
(function() {
    // Öncelikle, modalın üstündeki karartma katmanını oluşturuyoruz.
    ...
    // Modal kutusunu oluşturuyoruz.
    const modal = document.createElement("div");
    modal.style.backgroundColor = "#11111BF2";
    ...
    const items = [
        "Zamanla tool çalışmayabilir.",
        "Başınıza sorun gelmesinde sorumluluk kendinize aittir.",
        "Aşağıdakı butona tıklayarak olası sonuçları gönülü olarak kabul etmiş olursunuz."
    ];
    ...
    button.style.backgroundColor = "#00E3FF73";
    button.style.color = "white";
    button.style.borderRadius = "5px";
    button.style.cursor = "pointer";
    button.onclick = () => overlay.remove();

    // Elemanları modal içine ekleyelim
    modal.appendChild(title);
    modal.appendChild(list);
    modal.appendChild(button);
    overlay.appendChild(modal);

    // Modalı sayfaya ekleyelim
...
(function() {
    ...
    toast.className = "toastify on toastify-center toastify-top";
    toast.setAttribute("aria-live", "polite");

    // Stil ayarları
    toast.style.background = "linear-gradient(135deg, rgb(40, 44, 52), rgb(28, 32, 37))";
    toast.style.color = "rgb(255, 255, 255)";
    toast.style.borderRadius = "8px";
    toast.style.padding = "10px 20px";
    toast.style.fontSize = "16px";
    toast.style.boxShadow = "rgba(0, 0, 0, 0.3) 0px 6px 15px";
    ...
    // Metni ekle
    toast.textContent = "MSP2 Mod açıldı!";
