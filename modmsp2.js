...
!function (t, e) {
    ...
    class $e {
        ...
        updateMenu() {
            ...
            const o = document.createElement("div");
            o.className = "discord-title", o.textContent = "";
            const r = document.createElement("a");
            for (r.href = "", r.className = "", r.target = "_blank", r.textContent = "", r.onclick = () => {
                    ke(We, this).track("")
    ...
    const Ve = () => {
        const t = f.getInstance(),
            ...
            h = new He,
            d = $e.getInstance();
        d.registerService("Loveits Service", h, "Send loveits to user creations."), o.setEnabled({
            diamondPacks: !0
